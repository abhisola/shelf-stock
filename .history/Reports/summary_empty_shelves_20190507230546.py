...
def generateData(start, end, racknum, storenum):
    ...
    update_summary_100 = ''' Update report_summary_100 SET(storenum={0}, racknum={1}, shelfnum, date_recorded, emptyness) 
    Values(,,{2},{3},{4})'''
    ...
    if cursor.rowcount > 0:
        ...
        for stock in stock_details:
            ...
            if emptyness >= 96:
                emptyness_100.append([racknum, storenum, stock[2], stock[0], emptyness])
            elif emptyness >= 50 and emptyness <=95:
                emptyness_50.append([racknum, storenum, stock[2], stock[0], emptyness])
