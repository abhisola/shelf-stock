...
def generateData(start, end, racknum, storenum):
    ...
    if cursor.rowcount > 0:
        ...
        for stock in stock_details:
            ...
            if emptyness >= 96:
                print('Fullness = {0}, Emptyness = {1}'.format(stock[1], emptyness))
        ...
        for row in emptyness_100:
            ...
            if cursor.rowcount > 0:
                ...
                if(cursor.rowcount > 0):
                    print('Summary_100 Row Updated For Racknum {0}, ShelfNum {1}!'.format(racknum, shelfnum))
            else:
                cursor.execute(insert_summary_100.format(storenum, racknum, shelfnum, date_recorded, emptyness))
                if(cursor.rowcount > 0):
                    print('Summary_100 Row Inserted!')
